...
public class startApp {
    ...
    public void SeleniumPulldata() throws Exception {
        ...
        if(table_size != savedAmount) {
            ...
            bot.sendToTelegram("<b>"+amount + " Order masuk</b>!%0A " + "total: " + table_size + ",%0A Date : "+ newfile.getDate() + ",%0A Recipient: NP-"+newfile.getDatas().get(value-1).getGlobalIndex() + " : "+newfile.getDatas().get(value-1).getName() + ",%0A Product : "+ newfile.getDatas().get(value-1).getProduct());
